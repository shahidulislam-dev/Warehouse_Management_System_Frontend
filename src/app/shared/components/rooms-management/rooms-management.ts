...
export class RoomsManagement implements OnInit {
  ...
  navigateToAllRooms(): void {
    ...
    this.router.navigate([baseRoute + '/rooms/all']);
  }

  navigateToWarehouseRooms(warehouseId: number): void {
    const baseRoute = this.authService.getDashboardRoute();
    this.router.navigate([baseRoute + '/rooms/warehouse', warehouseId]);
  }

  navigateToFloorRooms(warehouseId: number, floorId: number): void {
    const baseRoute = this.authService.getDashboardRoute();
    this.router.navigate([baseRoute + '/rooms/warehouse', warehouseId, 'floor', floorId]);
  }
